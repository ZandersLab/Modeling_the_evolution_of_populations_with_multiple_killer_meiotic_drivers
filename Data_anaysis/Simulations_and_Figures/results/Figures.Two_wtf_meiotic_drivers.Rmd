...
o model the ability of a meiotic driver to increase its allele frequency,
I assume that all gametes present in the population have the same frequency.
Such that $x_{1,...,n}=\frac{1}{n}$.

The frequency of the query gamete is $x_1=\frac{1}{n}$, while the rest of the population is
$x_1$. Then $x_1+x_{(n-1)}=\sum x_{1...n}=1$.


For example, in the case of three distinct meiotic drivers, with their gamete
frequencies $x_1,x_2,x_3=\frac{1}{n}$,initally,

$$x_1'=\frac{(x_1^2+x_{1}x_{2}(1-t_{2})+x_{1}x_{3}(1-t_{3}))}{\overline{W}}$$

$$x_1'=\frac{(\frac{1}{n})^2+(\frac{1}{n})^2(1-t_{2})+(\frac{1}{n})^2(1-t_{3})}{\overline{W}}$$

then $$x_1'=\frac{(\frac{1}{n})^2+(\frac{1}{n})^2(n-1)[ 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}]}{\overline{W}}$$,
or $$x_1'=\frac{(\frac{1}{n})^2[1+(n-1)[ 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}]}{\overline{W}}$$,

Where $$\overline {W}= n(\frac{1}{n})^2+(\frac{1}{n})^2n(n-1)(1-\frac{\sum{t_{1,..,n}}}{n})$$,
simplifying,

 $$\overline {W}= \frac{1}{n}+\frac{n-1}{n}(1-\frac{\sum{t_{1,..,n}}}{n})$$,

By using these equations we can solve, when the  frequency of the query gamete, $x_1'-x_1>0$. Where 
if it increases frequency, it will do it at the expense of the rest of the population because $x_1'+x_{n-1}'=1$, and
the frequency of every gamete is the same $x_1=\frac{1}{n}$

By substituting the terms, we obtain.

$$\frac{(\frac{1}{n})^2[1+(n-1)[ 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}]}{\overline{W}} > \frac{1}{n} $$

$$(\frac{1}{n})^2[1+(n-1)[ 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}] > \frac{1}{n}\overline{W} $$

$$(\frac{1}{n})^2[1+(n-1)[ 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}] > \frac{1}{n}(\frac{1}{n}+\frac{n-1}{n}(1-\frac{\sum{t_{1,..,n}}}{n}) )$$

$$(\frac{1}{n})^2[1+(n-1)[ 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}] > (\frac{1}{n})^2(1+(n-1)(1-\frac{\sum{t_{1,..,n}}}{n}) $$

$$(n-1)( 1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1}) > (n-1)(1-\frac{\sum{t_{1,..,n}}}{n}) $$

$$1 + \frac{-\sum{t_{2,..,n}}+t_1}{n-1} > 1-\frac{\sum{t_{1,..,n}}}{n} $$

$$\frac{-\sum{t_{2,..,n}}+t_1}{n-1} > -\frac{\sum{t_{1,..,n}}}{n} $$

$$n+(-\sum{t_{2,..,n}}+t_1) > -\sum{t_{1,..,n}}(n-1) $$

$$nt_1-n\sum{t_{2,..,n}} > -n\sum{t_{1,..,n}}+\sum{t_{1,..,n}} $$

$$nt_1 > \sum{t_{1,..,n}} $$

$$t_1 > \frac{\sum{t_{1,..,n}}}{n} $$

or
$$\frac{t_1}{\sum{t_{1,..,n}}} > \frac{1}{n} $$
